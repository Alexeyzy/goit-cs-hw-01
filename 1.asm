...
_start:
    ...
    sub al, [c] ; Віднімаємо значення по адресі [с] у регістр al та збергігаємо результат в al 
    add al, [a] ; Додаємо значення по адресі [a] у регістр al та збергігаємо результат в al 
